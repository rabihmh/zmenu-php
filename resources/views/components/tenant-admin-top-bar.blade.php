    ...
    <ul class="navbar-nav ml-auto">
            ...
            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <span class="badge badge-danger badge-counter"><span
                        id="notification-count">{{$unread_notifications_count??0}}</span>+</span>
            </a>
            <!-- Dropdown - Alerts -->
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                @forelse($notifications as $notification)
                    <a class="dropdown-item d-flex align-items-center" href="{{json_decode($notification->data)->url}}/?notification_id={{$notification->id}}">
                        ...
                        <div>
                            <div
                                class="small text-gray-500">{{Carbon\Carbon::parse($notification->created_at)->locale('en')->diffForHumans()}}</div>
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{\Illuminate\Support\Facades\Auth::guard('web')->user()->name}}</span>
