...
!(function (t) {
    ...
    return (
      ...
      b(t, function (t, e) {
        ...
        if (n)
          return (
            (n = o[e](n)),
            (o[h[e].cache] = n[h[e].cache]),
            (a = o._rgba = n._rgba),
            !1
          );
      }),
      a.length
        ? ("0,0,0,0" === a.join() && u.extend(a, f.transparent), o)
        : f[r]
    );
  }
  function M(t, e, n) {
  ...
  function S(t) {
    ...
    if (r && r.length && r[0] && r[r[0]])
      for (n = r.length; n--; )
        "string" == typeof r[(e = r[n])] && (o[s.camelCase(e)] = r[e]);
    else for (e in r) "string" == typeof r[e] && (o[e] = r[e]);
    return o;
  }
  function j(t, e, n, r) {
    return (
      (t = { effect: (t = s.isPlainObject(t) ? (e = t).effect : t) }),
      s.isFunction((e = null == e ? {} : e)) && ((r = e), (n = null), (e = {})),
  ...
  return (
                ...
                o instanceof p
                  ...
                  : function (t, n) {
                      ...
                      b(n.props, function (t, e) {
                        ...
                        a[r] &&
                          u.inArray(null, a[r].slice(0, 3)) < 0 &&
                          ((a[r][3] = 1), n.from && (a._rgba = n.from(a[r])));
                    }
              ),
              this)
            : void 0
    ...
    (h.hsla.from = function (t) {
      ...
      var e = t[0] / 360,
        ...
        r = 2 * r - n;
      return [
        Math.round(255 * M(r, n, e + 1 / 3)),
        Math.round(255 * M(r, n, e)),
        Math.round(255 * M(r, n, e - 1 / 3)),
        t,
      ];
    }),
    b(h, function (f, t) {
      var a = t.props,
        ...
        c = t.from;
      (p.fn[f] = function (t) {
        if ((s && !this[i] && (this[i] = s(this._rgba)), t === l))
          return this[i].slice();
        var e,
          n = u.type(t),
        ...
        (u.cssHooks[a] = {
          set: function (t, e) {
            ...
            if ("transparent" !== e && ("string" !== u.type(e) || (n = k(e)))) {
              if (((e = p(n || e)), !i.rgba && 1 !== e._rgba[3])) {
                for (
                  r = "backgroundColor" === a ? t.parentNode : t;
          ...
          (u.fx.step[a] = function (t) {
            t.colorInit ||
              ...
              (t.end = p(t.end)),
              (t.colorInit = !0)),
              u.cssHooks[a].set(t.elem, t.start.transition(t.end, t.pos));
          });
      });
    }),
    p.hook(
      ...
      function (t, e) {
        s.fx.step[e] = function (t) {
          (("none" !== t.end && !t.setAttr) || (1 === t.pos && !t.setAttr)) &&
            (w.style(t.elem, e, t.end), (t.setAttr = !0));
        };
      }
    ),
    s.fn.addBack ||
              ...
              (this.diff = (function (t, e) {
                ...
                for (n in e)
                  (r = e[n]),
                    t[n] !== r &&
                      (y[n] ||
                        (!s.fx.step[n] && isNaN(parseFloat(r))) ||
                        (o[n] = r));
                return o;
              })(this.start, this.end)),
              this
    ...
    s.fn.extend({
      addClass:
        ...
        function (t, e, n, r) {
          return e
            ? s.effects.animateClass.call(this, { add: t }, e, n, r)
      ...
      removeClass:
        ...
        function (t, e, n, r) {
          return 1 < arguments.length
            ? s.effects.animateClass.call(this, { remove: t }, e, n, r)
      ...
      toggleClass:
        ...
        function (t, e, n, r, o) {
          return "boolean" == typeof e || void 0 === e
            ...
            : s.effects.animateClass.call(this, { toggle: t }, e, n, r);
        }),
    ...
    s.extend(s.effects, {
      ...
      save: function (t, e) {
        for (var n = 0; n < e.length; n++)
          null !== e[n] && t.data(C + e[n], t[0].style[e[n]]);
      },
      restore: function (t, e) {
        for (var n, r = 0; r < e.length; r++)
          null !== e[r] &&
            (void 0 === (n = t.data(C + e[r])) && (n = ""), t.css(e[r], n));
      },
      ...
      removeWrapper: function (t) {
        ...
        return (
          t.parent().is(".ui-effects-wrapper") &&
            ...
            (t[0] !== e && !s.contains(t[0], e)) || s(e).focus()),
          t
        );
      },
